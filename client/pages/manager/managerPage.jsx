...
export function ManagerPage() {
  ...
  return (
    <div>
      ...
      <ul>
        <li>
          <Link to={"/manager/activities/new"} state={{ user: user }}>
            Create activity
          </Link>
        </li>
        <li>
          <Link to={"/manager/activities/edit"} state={{ user: user }}>
            Edit activities
          </Link>
        </li>
        <li>
          <Link to={"/manager/users/edit"} state={{ user: user }}>
            Edit users
          </Link>
        </li>
      </ul>
      ...
      <Routes>
        ...
        <Route
          ...
          element={<ListActivities user={user} />}
        ></Route>
